...
class HttpExchangeOutboundContactPointDetectorTests {
    ...
    void reportsUnresolvedOutboundCallsWhenNoTargetMapped() {
        Contribution contribution =
            new HttpExchangeOutboundContactPointDetector(new MockEnvironment(), Map.of()).detect(context(InventoryClient.class));
    ...
    void resolvesTargetServiceFromConfig() {
        ...
        Contribution contribution =
            new HttpExchangeOutboundContactPointDetector(new MockEnvironment(), targets).detect(context(InventoryClient.class));
    ...
    void ignoresAdaptersWithoutHttpExchange() {
        Contribution contribution =
            new HttpExchangeOutboundContactPointDetector(new MockEnvironment(), Map.of()).detect(context(NotAClient.class));
